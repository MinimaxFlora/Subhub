<template>
  <div class="subconverter-page">
        ...
        <el-card class="subconverter-card">
          <div slot="header" class="subconverter-hero">
            <div class="subconverter-hero__copy">
              <div class="subconverter-hero__brand">
                <img class="subconverter-hero__logo" src="logo.png" alt="Kejizero" />
                <span class="subconverter-hero__eyebrow">KEJIZERO / NEXT</span>
              </div>
    ...
    <div class="subconverter-social-dock" aria-label="页面底部快捷入口">
      ...
      <button v-if="tgBotLink" class="subconverter-social-btn" type="button" @click="gotoTgChannel" aria-label="Telegram" title="Telegram">
        <svg viewBox="0 0 24 24" fill="none" class="subconverter-social-btn__icon" aria-hidden="true">
      ...
      <button v-if="yglink" class="subconverter-social-btn" type="button" @click="gotoYouTuBe" aria-label="YouTube" title="YouTube">
        <svg viewBox="0 0 24 24" fill="none" class="subconverter-social-btn__icon" aria-hidden="true">
        ...
        <el-tab-pane label="JS排序节点" name="second">
          ...
          <el-form label-position="left">
            <el-form-item prop="uploadScript">
              <el-input v-model="uploadScript" placeholder="本功能暂停使用，可参考 sub-web-api 项目自行部署！" type="textarea"
        ...
        <el-tab-pane label="JS筛选节点" name="third">
          ...
          <el-form label-position="left">
            <el-form-item prop="uploadFilter">
              <el-input v-model="uploadFilter" placeholder="本功能暂停使用，可参考 sub-web-api 项目自行部署！" type="textarea"
                :autosize="{ minRows: 15, maxRows: 15 }" maxlength="50000" show-word-limit></el-input>
            </el-form-item>
          </el-form>
          <div style="float: right">
...
export default {
  data() {
    return {
      ...
      options: {
        ...
        shortTypes: {
          "Kejizero短链": "https://short.kejizero.xyz/short",
          "v1.mk": "https://v1.mk/short",
          "d1.mk": "https://d1.mk/short",
          "dlj.tf": "https://dlj.tf/short",
        },
        customBackend: {
          "Kejizero自建后端": defaultBackend,
          "公共-增强型后端": "https://url.v1.mk",
          "公共-备用后端": "https://api.v1.mk",
        },
        backendOptions: [
      ...
      form: {
        ...
        shortType: "https://short.kejizero.xyz/short",
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert(`<div style="text-align:center;font-size:15px"><strong><span style="font-size:20px">欢迎使用 Kejizero订阅转换</span></strong></br><strong><span style="font-size:16px">支持 Clash / Surge / Sing-Box / V2Ray / Quantumult X 等主流客户端</span></strong></br></div>`, 'Kejizero订阅转换', {
...
.subconverter-hero__brand {
  display: flex;
  align-items: center;
  gap: 14px;
}

.subconverter-hero__logo {
  width: 46px;
  height: 46px;
  border-radius: 12px;
  object-fit: cover;
